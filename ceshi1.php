...
<?php
    ...
    $init = @$_POST["init"];//game restart //重新开始游戏
...
//pan ding zhi ding qu yu zhang ai shu liang
        for($i=0;$i<$rows;$i++){//all the rows  
            for($j=0;$j<$cols;$j++){//all the cols  
...
//ru guo chu fa zhang ai you xi jie shu bao guo ti
    }else{  
        $data = $_POST;//get data  
...
//jian ce you xi jin cheng zhuang tai ru guo zheng chang dao ji shi kai qi
...
//she zhi jie dian ru guo jie dian kai qi qi yong lu ru han shu
...
<body>
    ...
    <?php   
        ...
        else if($checkflag == 2)echo "太笨了，又被雷炸死了<br />";  
    ?>  
